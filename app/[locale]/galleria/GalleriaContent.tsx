...
/**
 * Contenuto client della pagina /galleria (stato lightbox, swipe).
 * La pagina server (page.tsx) fornisce title/description SEO e passa il locale.
 */
export default function GalleriaContent({ locale }: { locale: Locale }) {
